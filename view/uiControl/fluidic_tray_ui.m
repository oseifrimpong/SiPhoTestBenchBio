...
obj.gui.(parentStruct)(panelIndex).fldTrayUI.settingsButton = uicontrol(...
    ...
    'String', 'Settings', ...
    'Callback', {@fld_tray_settings_cb, obj, parentStruct, panelIndex});
...
% shon 12/27/2013
totalWellNum = obj.instr.fluidicStage.Param.FrontPlate + ...
    obj.instr.fluidicStage.Param.BackPlate;
...
obj.gui.(parentStruct)(panelIndex).fldTrayUI.wellNumPopup = uicontrol(...
    ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
    'Value', obj.instr.fluidicStage.CurrentWell, ...
    'Position', [.25, .3, popupSize], ...
    'String', num2str((1:totalWellNum)'), ...
    'FontSize', 7);

% set button
obj.gui.(parentStruct)(panelIndex).fldTrayUI.setButton = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).fldTrayUI.mainPanel, ...
    'Style', 'pushbutton', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
    ...
    'String', 'Set', ...
    'Callback', {@fld_tray_set_cb, obj, parentStruct, panelIndex});
...
function fld_tray_settings_cb(~, ~, obj, parentStruct, panelIndex)
...
function fld_tray_set_cb(~, ~, obj, parentStruct, panelIndex)
wellNum = get(obj.gui.(parentStruct)(panelIndex).fldTrayUI.wellNumPopup, 'Value');
obj.instr.fluidicStage.setWellNumber(wellNum); % set well #
msg = [obj.instr.fluidicStage.Name, ': Current Well: ', num2str(obj.instr.fluidicStage.CurrentWell)];
obj.msg(msg);
set(obj.gui.(parentStruct)(panelIndex).fldTrayUI.ejectButton, 'Enable', 'on');
set(obj.gui.(parentStruct)(panelIndex).fldTrayUI.loadButton, 'Enable', 'off');
set(obj.gui.(parentStruct)(panelIndex).fldTrayUI.moveButton, 'Enable', 'on');
...
totalWellNum = ...
    obj.instr.fluidicStage.Param.FrontPlate + obj.instr.fluidicStage.Param.BackPlate;

function recipe = load_recipe(benchObj, FileName)
    ...
    try
        ...
        recipe.pauseRecipe = logical(zeros(size(recipe.reagent)));
    ...
    %    recipe = {well, time, velocity, reagent, comment};
        msg = 'Recipe file loaded succesfully!';
        benchObj.msg(msg);
        
    catch ME
        
        recipe = {};
        msg = strcat('Error in recipe file, failed to load recipe!');
        benchObj.msg(msg);
